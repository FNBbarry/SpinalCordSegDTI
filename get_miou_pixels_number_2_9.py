...
if __name__ == "__main__":
    # initial_thresholds = [0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5]
    ...
    for class_index in range(len(initial_pixels_numbers)):
        if class_index == 0:
            ...
            # thresholds = initial_thresholds
            # thresholds[class_index-1] = (max_iou_index+500)/1000
            pixels_numbers = initial_pixels_numbers# uncomment this below line when apply pixel_number
        ...
        for i in range(1,301):# uncomment this below line when apply pixel_number
            ...
            #-------------------------------------------------------#
            VOCdevkit_path  = r'E:\data\W_L_CSM_segmentation\CSM_DTI_10classes_confidence_map_max_distance_point'

            image_ids       = open(os.path.join(VOCdevkit_path, "VOC2007/ImageSets/Segmentation/val.txt"),'r').read().splitlines()
            gt_dir          = os.path.join(VOCdevkit_path, "VOC2007/SegmentationClass/")
            # miou_out_path   = "miou_out"
            # miou_out_path   = "miou_out/"+str(class_index+1)+"/"+str(i/1000)
            miou_out_path   = "miou_out/"+str(class_index+2)+"/"+str(i)# uncomment this below line when apply pixel_number
            ...
            if miou_mode == 0 or miou_mode == 2:
                ...
                # all_results[0,i-500]=IoUs[class_index+1]
                # all_results[1,i-500]=PA_Recall[class_index+1]
                # all_results[2,i-500]=Precision[class_index+1]
                all_results[0,i-1]=IoUs[class_index+2]# uncomment this below line when apply pixel_number
                all_results[1,i-1]=PA_Recall[class_index+2]# uncomment this below line when apply pixel_number
                all_results[2,i-1]=Precision[class_index+2]# uncomment this below line when apply pixel_number
                print("Get miou done.")
